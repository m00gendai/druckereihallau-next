        ...
        <article className="article">
          ...
          <ul>
            {drucksachen.map((item, index)=>{
              return <li>{`${index === drucksachen.length-1 ? "...und" : ""} ${item}`}</li>
            })}
          </ul>
          ...
          <div className={s.container}>
            <ul>
              ...
              return <li>{`${index === dienste.length-1 ? "...und" : ""} ${item}`}</li>
            })}
              </ul>
              ...
              return <li>{`${index === skills.length-1 ? "...und" : ""} ${item}`}</li>
            })}
            </ul>
            ...
            <ul>
              ...
              return <li>{`${index === grief.length-1 ? "...und" : ""} ${item}`}</li>
            })}
            </ul>
